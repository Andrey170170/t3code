...
An idea restores only its folder; a project restores its whole workspace and restarts it. While
another thread is working in the same idea or workspace, the restore is refused; try again once it
finishes. If Trellis could not snapshot a
