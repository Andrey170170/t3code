...
describe("agent browser access", () => {
  ...
  const startSessionWith = (
    ...
    options?: { readonly withoutOrchestration?: boolean; readonly enableAgentTaskAccess?: boolean },
  ) =>
    Effect.gen(function* () {
      ...
      const providerLayer = makeProviderServiceLive({
        ...
        Layer.provide(
          ServerSettings.ServerSettingsService.layerTest({
            ...
            enableAgentTaskAccess: options?.enableAgentTaskAccess ?? false,
