...
describe("ThreadSettlementReactor", () => {
  it.effect("sweeps immediately when an import creates a thread", () =>
    Effect.scoped(
      Effect.gen(function* () {
        ...
        yield* Effect.gen(function* () {
          ...
          const old = makeThread("old-import", {
            latestUserMessageAt: "2026-08-20T00:00:00.000Z",
            latestTurn: null,
            updatedAt: NOW,
          });
          const recent = makeThread("recent-import", {
            latestUserMessageAt: NOW,
            latestTurn: null,
            updatedAt: NOW,
          });
          const pinned = makeThread("pinned-import", {
            latestUserMessageAt: "2026-08-20T00:00:00.000Z",
            latestTurn: null,
            pinnedAt: NOW,
          });
          yield* Ref.set(fixture.snapshots, makeSnapshot([old, recent, pinned]));
          yield* fixture.publishEvent({
            type: "thread.created",
            sequence: 2,
            eventId: EventId.make("import-created"),
