...
import IconCircleMinusFilled from "@tabler/icons-react-native/IconCircleMinusFilled";
...
const ANDROID_ICON_BY_SF_SYMBOL = {
  ...
  "checkmark.circle.fill": IconCircleCheckFilled,
  "minus.circle.fill": IconCircleMinusFilled,
