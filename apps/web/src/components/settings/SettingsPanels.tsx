...
export function useSettingsRestore(onRestored?: () => void) {
  ...
  const changedSettingLabels = useMemo(
    () => [
      ...
      ...(settings.enableAgentTaskAccess !== DEFAULT_UNIFIED_SETTINGS.enableAgentTaskAccess
        ? ["Agent task access"]
        : []),
    ...
    [
      ...
      settings.enableAgentTaskAccess,
  ...
  const restoreDefaults = useCallback(async () => {
    ...
    updateSettings({
      ...
      enableAgentTaskAccess: DEFAULT_UNIFIED_SETTINGS.enableAgentTaskAccess,
    });
    onRestored?.();
  }, [
